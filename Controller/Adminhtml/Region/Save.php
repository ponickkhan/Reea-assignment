...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Rafi\Reea\Model\Region::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('rafi_reea_region');
            ...
            $this->dataPersistor->set('rafi_reea_region', $data);
